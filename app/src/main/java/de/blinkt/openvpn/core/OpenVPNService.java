...
import io.jetstudio.jetvpn.R;
import io.jetstudio.jetvpn.ui.DetailsActivity;
import io.jetstudio.jetvpn.utils.TotalTraffic;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    public static final String START_SERVICE = "io.jetstudio.jetvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "io.jetstudio.jetvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "io.jetstudio.jetvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "io.jetstudio.jetvpn.DISCONNECT_VPN";
    public static final String VPN_STATUS = "io.jetstudio.jetvpn.VPN_STATUS";
    private static final String PAUSE_VPN = "io.jetstudio.jetvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "io.jetstudio.jetvpn.RESUME_VPN";
    ...
    private String createNotificationChannel() {
        ...
        try {
            String channelName = "Secure VPN Background Service";
    ...
    PendingIntent getLogPendingIntent() {
        ...
        intent.putExtra(DetailsActivity.TYPE_START, DetailsActivity.TYPE_FROM_NOTIFY);
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("de.blinkt.openvpn.OpenVPNThreadv3");
